...
Empleado crear_empleado(int dni, Cadena apellido, Cadena nombre, Fecha fecha_de_alta, Turno turno, long celular)
{
        Empleado empleado;
        empleado.dni = dni;
        copiar_cadena(empleado.apellido, apellido);
        copiar_cadena(empleado.nombre, nombre);
        empleado.fecha_de_alta = fecha_de_alta;
...
Empleado ingresar_empleado(int dni)
{
        Empleado empleado;
        empleado.dni = dni;
        ingresar_cadena("apellido: ", empleado.apellido);
        ingresar_cadena("nombre: ", empleado.nombre);
